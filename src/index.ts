 ...
 *
 * MCP server management — authoring composition rows, the loading mode, and the
 * per-row tool filters — is the separate plugin
 * `@zhang-guo-wen/dsh-mcp-manager`; this package carries no MCP code.
 *
