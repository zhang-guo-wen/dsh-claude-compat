...
const PLUGIN_ID = "@guowenzhang/dsh-claude-compat";
...
function isInstructionsSource(source, loader) {
	...
	if (kind === `plugin:@guowenzhang/dsh-claude-compat#${loader}`) return true;
	return kind === "plugin" && source.plugin === `@guowenzhang/dsh-claude-compat#${loader}`;
}
//#endregion
